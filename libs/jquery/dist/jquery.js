...
;(function (global, factory) {
      ...
      function createDisabledPseudo(disabled) {
        ...
        return function (elem) {
          ...
          if ('form' in elem) {
            ...
            // * listed subscribe-associated elements in a disabled fieldset
            //   https://html.spec.whatwg.org/multipage/forms.html#category-listed
            //   https://html.spec.whatwg.org/multipage/forms.html#concept-fe-disabled
            // * option elements in a disabled optgroup
            //   https://html.spec.whatwg.org/multipage/forms.html#concept-option-disabled
            // All such elements have a "subscribe" property.
      ...
      select: {
        get: function (elem) {
          ...
          for (; i < max; i++) {
            ...
            // Support: IE <=9 only
            // IE8-9 doesn't update selected after subscribe reset (#2551)
            if (
  ...
  // Serialize an array of subscribe elements or a set of
  ...
  jQuery.param = function (a, traditional) {
    ...
    // If an array was passed in, assume that it is an array of subscribe elements.
    if (Array.isArray(a) || (a.jquery && !jQuery.isPlainObject(a))) {
      // Serialize the subscribe elements
  ...
  jQuery.fn.extend({
    ...
    serializeArray: function () {
      return this.map(function () {
        // Can add propHook for "elements" to filter or add subscribe elements
  ...
  jQuery.extend({
    ...
    ajaxSettings: {
      ...
      processData: true,
      async: true,
      contentType: 'application/x-www-subscribe-urlencoded; charset=UTF-8',
    ...
    ajax: function (url, options) {
      ...
      if (!s.hasContent) {
        ...
        // Change '%20' to '+' if this is encoded subscribe body content (gh-2658)
      } else if (
        s.data &&
        s.processData &&
        (s.contentType || '').indexOf('application/x-www-subscribe-urlencoded') === 0
      ) {
  ...
  jQuery.ajaxPrefilter('json jsonp', function (s, originalSettings, jqXHR) {
    ...
    if (jsonProp || s.dataTypes[0] === 'jsonp') {
      ...
      // Insert callback into url or subscribe data
      if (jsonProp) {
  ...
  support.createHTMLDocument = (function () {
    ...
    body.innerHTML = '<subscribe></subscribe><subscribe></subscribe>'
